...
$$
\text{AFRI 1.6} = \frac{\text{RED EDGE 4}-0.66 \times \text{SWIR 1}}{\text{RED EDGE 4}+0.66 \times \text{SWIR 1}}
$$

### AFRI 2.1: Aerosol free vegetation index 2.1 (Karineli, 2001)

$$
\text{AFRI 2.1} = \frac{\text{RED EDGE 4}-0.5 \times \text{SWIR 2}}{\text{RED EDGE 4}+0.5 \times \text{SWIR 2}}
$$
...
$$
\text{ARVI 2} = -0.18 + 1.17 \times \frac{NIR-RED}{NIR+RED}
$$
...
$$
\text{CRI 550} = \frac{1}{Blue}-\frac{1}{GREEN}
$$
...
$$
\text{EVI 2} = 2.4 \times \frac{NIR-RED}{NIR+RED+1}
$$
...
$$
\text{MCARI 1} = 1.2 \times [2.5 \times (NIR-RED)-1.3 \times (NIR-GREEN)]
$$
...
$$
\text{MSAVI 2} = \frac{2 \times NIR+1-\sqrt{(2 \times NIR+1)^2-8 \times (NIR-RED)}}{2}
$$

### MSR 670: Modified Simple Ratio 670/800 (Chen, 1996)

$$
\text{MSR 670} = \frac{\frac{NIR}{RED}-1}{\sqrt{\frac{NIR}{RED}-1}}
$$

### MTVI 2: Modified Triangular Vegetation Index 2 (Haboudane, 2004)

$$
\text{MTVI 2} = 1.5 \times \frac{1.2 \times (NIR-GREEN)-2.5 \times (RED-GREEN)}{\sqrt{2 \times (NIR+1)^2-(6 \times NIR -5 \times \sqrt{RED})-0.5}}
$$
...
$$
VARIgreen = \frac{GREEN-RED}{GREEN-RED+BLUE}
$$
